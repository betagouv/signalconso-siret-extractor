...
export class WebsiteNotFoundException extends BadRequestException {
  constructor(website: string) {
    super(`Website not found: ${website}`)
  }
}

export class WebsiteFailedException extends BadRequestException {
